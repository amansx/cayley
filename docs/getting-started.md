...
This tutorial requires you to be connected to **local Cayley installation**. For more information on installing Cayley locally, see [Install Cayley](https://github.com/amansx/cayley/tree/06f7114d4ad1725d58f16fc5fdc9394f293c3539/docs/installation.md).
...
[Sample Data](https://github.com/amansx/cayley/raw/master/data/30kmoviedata.nq.gz)
